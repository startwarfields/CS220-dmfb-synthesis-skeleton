...
/*
 * Stage 2: Compilation (Static Stage on Left, Dynamic Additions on right)
 * -> Schedule/Map | Converts JSON data to DAG tags
 * -> Place/route  | Test Route Emergency Lanes (Is it possible to do it NOW)
 * End Goal: Typical Compiled DAG with Tags (These Tags contain instructions if we need to recompile at runtime)
 * This just converts the JSON Data structure to a DAG format, to help reduce needed structure changes
 */
////////////////////////////////////////////////////////////////////////////////////
////////////////////////START OF STATIC COPY ///////////////////////////////////////
    ...
    std::cout << " Dynamically Compiling CFG" << endl << "-----------------------------------------------" << endl;
